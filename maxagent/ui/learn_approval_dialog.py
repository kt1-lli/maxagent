...
QDialog#LearnApprovalDialog QLabel { color:#d4d4d4; background:transparent; }
...
QDialog#LearnApprovalDialog QPushButton:hover {
    background-color:#5a5a5a;
    background-image:none;
    border:1px solid #6a6a6a;
}
QDialog#LearnApprovalDialog QPushButton:pressed {
    background-color:#3a3a3a;
    background-image:none;
}
QDialog#LearnApprovalDialog QPushButton:disabled {
...
QDialog#LearnApprovalDialog QPushButton#approveBtn:pressed {
...
QDialog#LearnApprovalDialog QPushButton#rejectBtn:pressed {
